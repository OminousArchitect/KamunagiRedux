...
namespace KamunagiOfChains.Data.Bodies.Kamunagi.Extra
{
	public class KamunagiSkillFamilyExtra : Concentric, ISkillFamily
	{
		...
		{
			GetAsset<MothMoth>(), GetAsset<XinZhao>(), GetAsset<SummonTatari>(), GetAsset<SummonNugwisomkami>(), GetAsset<MashiroBlessing>(), GetAsset<KuonFlashbang>(), GetAsset<HonokasVeil>(), GetAsset<Overzeal>()
		};
