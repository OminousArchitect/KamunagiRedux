...
namespace KamunagiOfChains.Data.Bodies.Kamunagi.Secondary
{
    ...
    public class EnnakamuyEarth : Asset, ISkill, IEffect, IProjectile, IProjectileGhost
    {
        ...
        {
            var effect = GetGameObject<EnnakamuyEarth, IProjectileGhost>().InstantiateClone("BoulderChargeEffect", false);
        ...
        {
            var projectile = LoadAsset<GameObject>("RoR2/Base/Grandparent/GrandparentBoulder.prefab")!.InstantiateClone("BoulderProjectile", true);
