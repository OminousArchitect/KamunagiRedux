...
namespace KamunagiOfChains.Data.Bodies.Kamunagi.Special
{
    public class SobuGekishohaState : BaseTwinState
    {
        ...
        public override void OnEnter()
        {
            ...
            ScaleParticleSystemDuration component = voidSphereMuzzle.GetComponent<ScaleParticleSystemDuration>();
            if (component)
            {
    ...
    public class SobuGekishoha : Asset, ISkill, IEffect
    {
        ...
        public class VoidSphere : Asset, IEffect
        {
            GameObject IEffect.BuildObject()
            {
                var effect = LoadAsset<GameObject>("RoR2/DLC1/VoidRaidCrab/VoidRaidCrabSpinBeamChargeUp.prefab")!.InstantiateClone("VoidTracerSphere", false);
