...
namespace KamunagiOfChains.Data.Bodies.Kamunagi.Utility
{
    public class AtuysTidesState : BaseTwinState
    {
        ...
        public override void FixedUpdate()
        {
            ...
            if (fixedAge >= 5f) outer.SetNextStateToMain();
            if (projectilesFired > Mathf.FloorToInt(fixedAge * totalProjectileCount) || projectilesFired >= totalProjectileCount) return;
    ...
    public class AtuysTides : Asset, IProjectileGhost, IProjectile, ISkill
    {
        ...
        {
            var tidalProjectileGhost = LoadAsset<GameObject>("RoR2/DLC1/ClayGrenadier/ClayGrenadierBarrelGhost.prefab")!.InstantiateClone("TwinsGeyserGhost", false);
        ...
        {
            var tidalProjectile = LoadAsset<GameObject>("RoR2/DLC1/ClayGrenadier/ClayGrenadierBarrelProjectile.prefab")!.InstantiateClone("TwinsGeyserProjectile", true);
            ...
            tidalProjectile.GetComponent<ProjectileImpactExplosion>().impactEffect = GetGameObject<AtuysTidesImpact, IEffect>();
    ...
    public class AtuysTidesEruption : Asset, IProjectile, IEffect
    {
        ...
        {
            var tidalEruptionEffect = LoadAsset<GameObject>("RoR2/DLC1/ClayGrenadier/ClayGrenadierMortarExplosion.prefab")!.InstantiateClone("TwinsGeyserEruptionEffect", false);
            ...
            eruptionDecalMaterial.SetTexture("_RemapTex", LoadAsset<Texture2D>("RoR2/Base/Common/ColorRamps/texRampLightning2.png"));
            ...
            foreach (var r in tidalEruptionEffect.GetComponentsInChildren<ParticleSystemRenderer>())
            {
                switch (r.name)
                {
                    ...
                    case "Billboard, Splash":
                        r.material.SetTexture("_RemapTex", LoadAsset<Texture2D>("RoR2/Base/Common/ColorRamps/texRampLightning2.png"));
        ...
        GameObject IProjectile.BuildObject()
        {
            var tidalEruptionProjectile = LoadAsset<GameObject>("RoR2/DLC1/ClayGrenadier/ClayGrenadierMortarProjectile.prefab")!.InstantiateClone("TwinsGeyserEruptionProjectile", true);
    ...
    public class AtuysTidesImpact : Asset, IEffect
    {
        GameObject IEffect.BuildObject()
        {
            var tidalImpactEffect = LoadAsset<GameObject>("RoR2/DLC1/ClayGrenadier/ClayGrenadierBarrelExplosion.prefab")!.InstantiateClone("TwinsGeyserGhostImpact", false);
            ...
            giDecalMaterial.SetTexture("_RemapTex", LoadAsset<Texture2D>("RoR2/Base/Common/ColorRamps/texRampLightning2.png"));
            ...
            geyserParticlesMat.SetTexture("_RemapTex", LoadAsset<Texture2D>("RoR2/Base/Common/ColorRamps/texRampLightning2.png"));
            ...
            geyserParticles2Mat.SetTexture("_RemapTex", LoadAsset<Texture2D>("RoR2/Base/Common/ColorRamps/texRampLightning2.png"));
