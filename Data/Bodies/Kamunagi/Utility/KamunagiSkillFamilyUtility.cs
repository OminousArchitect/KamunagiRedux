...
namespace KamunagiOfChains.Data.Bodies.Kamunagi.Utility
{
	...
	
	{
		public IEnumerable<Asset> GetSkillAssets() =>
			new Asset[] { GetAsset<Mikazuchi>(), GetAsset<JachdwaltStrikes>(), GetAsset<WoshisZone>(), GetAsset<AtuysTides>(), GetAsset<HonokasVeil>(), GetAsset<TwinsChildTeleport>(), GetAsset<MothMoth>() };
